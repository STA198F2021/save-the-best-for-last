...
With this regression model, the result shows us that a one unit increase in daily alcohol consumption increases the number past failures by 0.11. Thus, daily alcohol consumption negatively impacts one's academic performance by contributing to the number of failed classes.
